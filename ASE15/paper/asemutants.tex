...
\ref{fig:harness} shows a CBMC harness for a function that takes two
sorted arrays as inputs, and outputs a third array containing exactly
one copy of each item appearing in either array, {\tt
  merge\_sorted\_nodups}.  This is a simple program, but typical of a
