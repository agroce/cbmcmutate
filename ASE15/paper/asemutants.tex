...
harness does not have any mutants that 1) verify the SUT but 2) kill
...
systems.  In this view, verification is always provisional, but we can best
gain confidence in it by making serious attempts to prove its inadequacy.
