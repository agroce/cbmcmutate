...
the permutation requirement remains in place.  However, it misses
version of quick sort that 1) preserve permutation 2) make the first
...
assumptions, the specification, or the problem size are necessarily
