...
Intel Core i7).  CBMC reports that 6 mutants do not compile (these
...
limit to size 4, again the same 8 mutants survive.
...
surviving mutants) and 2) the location of the fault is obviously
known.
