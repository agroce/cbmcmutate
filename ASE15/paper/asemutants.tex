...
interesting of these; we also successfully applied the method to bubble sort and a
duplicate-removing array merge function.
...
implementation of Dijkstra's shortest path algorithm, with the added
record-keeping to reconstruct all paths \cite{dijkstrasp}.
