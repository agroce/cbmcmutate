...
static void __rcu_process_callbacks(struct rcu_ctrlblk *rcp);
 /* MUTANT (del_stmt) */ /* static void rcu_process_callbacks(struct softirq_action *unused); */ 
...
void __init rcu_init(void)
{
	...
	__CPROVER_atomic_begin(); if (!covered[145]) {covered[145] = 1; total_covered += 1;} __CPROVER_atomic_end(); 
