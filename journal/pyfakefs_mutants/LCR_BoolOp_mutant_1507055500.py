...
class FakeFilesystem(object):
    ...
    def _IsRootPath(self, file_path):
        ...
        root_name = self._matching_string(file_path, self.root.name)
        # line: 1510
        return ((file_path == root_name) or ((not self.is_case_sensitive) or (file_path.lower() == root_name.lower())) or ((len(file_path) == 2) and self.StartsWithDriveLetter(file_path)))
