...
class FakeOsModule(object):
    ...
    def open(self, file_path, flags, mode=None, dir_fd=None):
        ...
        # line: 3241
        open_modes = _OpenModes(must_exist=(flags & os.O_CREAT), can_read=(not (flags & os.O_WRONLY)), can_write=(flags & (os.O_RDWR | os.O_WRONLY)), truncate=(flags & os.O_TRUNC), append=(flags & os.O_APPEND), must_not_exist=(flags & os.O_EXCL))
        # line: 3249
