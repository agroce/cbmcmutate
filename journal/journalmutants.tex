...
depth 1000 revealed a new fault:  
\url{https://github.com/jmcgeheeiv/pyfakefs/issues/321}.
...
without that change).  The second, after investigation, results in the
discovery of a particularly subtle and difficult-to-detect fault in
the file system.
