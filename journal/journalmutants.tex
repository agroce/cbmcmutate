...
have not been killed at all do not increase this threshold).
...
Taking the correspondences with Popper's ideas seriously, we arrive at
a some high-level conclusions:

\begin{itemize}
\item A verification harness (which includes both a specification and a
  definition of behaviors to apply the specification to) is equivalent 
...
is often, unlike science, not purely epistemological in the larger
