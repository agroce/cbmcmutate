...
problem of induction \cite{Hum2} is best solved by stating it cannot
...
Dijkstra meant his statement that testing ``can only show errors'' as
...
this line of thinking, to our knowledge, use Inductive Validiity Cores
(IVCs) \cite{WhalenIVC} to indicate correspondence between property
