...
\subsection{Adapting Falsification-Based Approaches to Automated Test Generation}
...
- Karl Popper, \emph{The Logic of Scientific Discovery} \cite{Popper}
\end{quote}
...
- Karl Popper, \emph{Conjectures and Refutations: The Growth of 
